...
import sys
if "Winforms_Template" in sys.modules:
    del sys.modules["Winforms_Template"]
...
win = MyWindow("Ventana con Ejemplos de Inputs", 1000, 1100)
...
# meter button
boton_seleccionar_elementos = MySelectButton(win, "elementos_seleccionados", 150, 550, "Seleccionar elementos", font_1)

#* Agregar el botón de selección de ruta
boton_seleccionar_ruta = MyPathFile(win, "ruta_archivo", 150, 650, "Seleccionar ruta", font_1)

boton_seleccionar_elementos = MySelectButton(win, "elementos_seleccionados 2", 150, 750, "Seleccionar elementos 2", font_1)

#* Agregar el botón de selección de ruta
boton_seleccionar_ruta = MyPathFile(win, "ruta_archivo 2", 150, 850, "Seleccionar ruta 2", font_1)
